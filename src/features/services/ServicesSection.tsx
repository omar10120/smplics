...
const ServicesSection = () => {
  ...
  return (
    <section className="py-20 bg-dark text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-10 w-60 h-60 rounded-full bg-primary/10 blur-3xl z-0" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredServices.map((service, index) => (
            ...
            >
              <div className={`h-full bg-dark/80 backdrop-blur-sm border rounded-2xl overflow-hidden transition-all duration-500 ${
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 bg-gradient-to-r from-dark to-dark/90 backdrop-blur-sm border border-white/10 rounded-2xl p-10 relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-60 h-60 bg-gradient-to-r from-primary/10 to-accent/10 rounded-full blur-3xl -translate-y-1/3 translate-x-1/3 z-0" />
